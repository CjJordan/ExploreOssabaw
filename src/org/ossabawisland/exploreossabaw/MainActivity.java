...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
	 ...
	 */
	OssabawViewPager viewPager;
	private static JournalFragment journal = new JournalFragment();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager = (OssabawViewPager) findViewById(R.id.pager);
	...
	public static JournalFragment getJournal(){
		return journal;
	}
	
	public static class AboutUsDialogFragment extends DialogFragment {
	    @Override
	    public Dialog onCreateDialog(Bundle savedInstanceState) {
	        AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.OssabawAlertDialog));
